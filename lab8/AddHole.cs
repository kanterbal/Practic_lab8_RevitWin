    ...
    public class AddHole : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            FamilySymbol familySymbol = new FilteredElementCollector(arDoc)
                ...
                .OfType<FamilySymbol>()
                .Where(x => x.Name.Equals("Отверстия"))
                .FirstOrDefault();
            ...
            if (view3D==null)
            {
                TaskDialog.Show("Ошибка", "Не найден 3д вид");
                return Result.Cancelled;
            }
            ...
            foreach(Duct d in ducts)
            {
                ...
                foreach(ReferenceWithContext refer in intersection)
                {
                    ...
                    Parameter width = hole.LookupParameter("Ширина_отв");
                    Parameter height = hole.LookupParameter("Высота_отв");
